...
%>
            <tr class="border-t hover:bg-gray-50">
                ...
                <!-- Image thumbnail -->
                <td class="py-2 px-4">
                    <img src="<%= request.getContextPath() + "/assets/images/materials/" + ((m.getImage() == null || m.getImage().isEmpty()) ? "assets/images/materials/default.png" : m.getImage())%>"
