        ...
        <c:if test="${userRole == 'Warehouse Manager' }">
            ...
            <div class="bg-white rounded-lg shadow-md p-6 transition-transform transform hover:scale-105">
                <div class="flex flex-col items-center text-center">
                    ...
                    <h3 class="text-lg font-semibold mb-2">Category Management</h3>
                    <p class="text-gray-600 mb-4">Manage category items and their descriptions.</p>
            ...
            <div class="bg-white rounded-lg shadow-md p-6 transition-transform transform hover:scale-105">
                <div class="flex flex-col items-center text-center">
                    ...
                    <h3 class="text-lg font-semibold mb-2">Unit Management</h3>
                    <p class="text-gray-600 mb-4">Manage unit.</p>
                    <a href="${pageContext.request.contextPath}/unit" class="bg-purple-600 hover:bg-purple-700 text-white py-2 px-4 rounded-lg transition duration-300">
                        Manage Unit 
                    </a>
                </div>
            </div>      
