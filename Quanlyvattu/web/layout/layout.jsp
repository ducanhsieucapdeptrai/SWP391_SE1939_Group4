    ...
    <div class="flex flex-1">
        ...
        <aside id="sidebar" class="bg-blue-800 text-white w-64 min-h-screen p-4 hidden md:block">
            <nav>
                <ul>
                    <li class="mb-1">
                        <a href="homepage.jsp" class="sidebar-item block px-4 py-2 rounded hover:bg-gray-700">
                            <i class="fas fa-tachometer-alt mr-2"></i> Dashboard
                        </a>
                    </li>
                    <li class="mb-1">
                        <a href="materiallist.jsp" class="sidebar-item block px-4 py-2 rounded hover:bg-gray-700">
                            <i class="fas fa-boxes mr-2"></i> Inventory
                        </a>
                    </li>
                    <li class="mb-1">
                        <a href="requestlist.jsp" class="sidebar-item block px-4 py-2 rounded hover:bg-gray-700">
                    ...
                    <li class="mb-1">
                        ...
                        <ul id="userManagerSubmenu" class="hidden ml-4 mt-1">
                            <li class="mb-1">
                                <a href="userlist.jsp" class="block px-3 py-2 rounded hover:bg-gray-600 text-gray-300 hover:text-white">
                                    <i class="fas fa-list mr-2"></i> User List
                                </a>
                            </li>
                            <li class="mb-1">
                                <a href="user-matrix.jsp" class="block px-3 py-2 rounded hover:bg-gray-600 text-gray-300 hover:text-white">
    ...
    <div id="mobileSidebar" class="fixed inset-0 bg-gray-800 bg-opacity-75 z-40 hidden">
        <div class="bg-blue-800 text-white w-64 min-h-screen p-4">
            ...
            <nav>
                <ul>
                    <li class="mb-1">
                        <a href="homepage.jsp" class="block px-4 py-2 rounded hover:bg-gray-700">Dashboard</a>
                    </li>
                    <li class="mb-1">
                        <a href="materiallist.jsp" class="block px-4 py-2 rounded hover:bg-gray-700">Inventory</a>
                    </li>
                    <li class="mb-1">
                        <a href="user-matrix.jsp" class="block px-4 py-2 rounded hover:bg-gray-700">User Authorization</a>
                    </li>
                    <li class="mb-1">
                        <a href="requestlist.jsp" class="block px-4 py-2 rounded hover:bg-gray-700">Request</a>
                    </li>
                    <li class="mb-1">
                ...
                <aside id="sidebar" class="bg-blue-800 text-white w-64 min-h-screen p-4 hidden md:block">
                    <nav>
                        <ul>
                            ...
                            <li class="mb-1">
                                <a href="${pageContext.request.contextPath}/materiallist.jsp" class="sidebar-item block px-4 py-2 rounded hover:bg-gray-700">
                                    <i class="fas fa-boxes mr-2"></i> Inventory
                                </a>
                            </li>
                            <li class="mb-1">
